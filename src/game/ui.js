...
export class UI {
    constructor(onWake, onAction, onEnter, onDeathAcknowledge, onRestart) {
        ...
        const roomTabActionsEl = document.getElementById("room-tab-actions");
        const roomTabPowerEl = document.getElementById("room-tab-power");
        ...
        const aiQueryButtonEl = document.getElementById("ai-query-button");
